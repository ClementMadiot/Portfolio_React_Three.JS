      ...
      >
        <div className="flex flex-col justify-center items-center mt-5">
          ...
          <div>
            ...
            <p className='my-2 text-white-100 font-medium lg:text-[26px] sm:text-[24px] xs:text-[20px] text-[17px] lg:leading-[40px]'>I develop 3d visuals, user <br /> interfaces and web applications</p>
          </div>
      </div>
